...
library AutomatorV2Helper {
    ...
    function parseRebalanceTicksJson(
        string memory ticks
    ) internal pure returns (IOrangeStrykeLPAutomatorV2.RebalanceTick[] memory) {
    ...
    function rawToConvertedRebalanceTicks(
        ...
        IOrangeStrykeLPAutomatorV2.RebalanceTick[] memory converted = new IOrangeStrykeLPAutomatorV2.RebalanceTick[](
            raw.length
        );
    ...
    function rawToConvertedRebalanceTick(
        ...
        return
            IOrangeStrykeLPAutomatorV2.RebalanceTick({
...
contract TestAutomatorV2Helper is Test {
    using AutomatorV2Helper for string;
    ...
    function test_parseRebalanceTicksJson() public {
        ...
        IOrangeStrykeLPAutomatorV2.RebalanceTick[] memory rebalanceTicks = ticks.parseRebalanceTicksJson();
