...
import {WETH_USDC_Fixture} from "./v2_1/fixture/WETH_USDC_Fixture.t.sol";
...
contract TestStrykeVaultInspectorV2 is WETH_USDC_Fixture, DealExtension {
    ...
    function test_freePoolPositionInToken01_noPositions() public {
        ...
        (uint256 token0, uint256 token1) = inspector.freePoolPositionInToken01(
            IOrangeStrykeLPAutomatorV2_1(address(automator))
        );
    ...
    function test_freePoolPositionInToken01_hasPositions() public {
        ...
        assertApproxEqRel(30 ether, token0, 0.003e18); // 0.3%
        assertApproxEqRel(300_000e6, token1, 0.003e18); // 0.3%
    }
    ...
    function test_freeAssets_noPositions() public {
        ...
        assertApproxEqRel(expected, inspector.freeAssets(IOrangeStrykeLPAutomatorV2_1(address(automator))), 0.0001e18); // 0.1%
    }
    ...
    function test_freeAssets_hasPositions() public {
        ...
        assertApproxEqRel(
            pooled + positioned,
            inspector.freeAssets(IOrangeStrykeLPAutomatorV2_1(address(automator))),
            0.001e18
        ); // 0.1%
    }
    ...
    function test_getAutomatorPositions_noPositions() public {
        ...
        ) = inspector.getAutomatorPositions(IOrangeStrykeLPAutomatorV2_1(address(automator)));
    ...
    function test_getTickAllLiquidity_hasPositions() public {
        ...
        for (int24 i = currentLower - 30; i <= currentLower + 30; i += 10) {
            uint128 liquidity = inspector.getTickAllLiquidity(IOrangeStrykeLPAutomatorV2_1(address(automator)), i);
    ...
    function test_getTickFreeLiquidity_hasPositions_notUtilized() public {
        ...
        for (int24 i = currentLower - 30; i <= currentLower + 30; i += 10) {
            uint128 liquidity = inspector.getTickFreeLiquidity(IOrangeStrykeLPAutomatorV2_1(address(automator)), i);
    ...
    function test_getTickFreeLiquidity_hasPositions_utilized() public {
        ...
        assertEq(
            0,
            inspector.getTickFreeLiquidity(IOrangeStrykeLPAutomatorV2_1(address(automator)), currentLower - 10)
        );
    ...
    function _rebalanceMintSingle(int24 lowerTick, uint128 liquidity) internal {
        IOrangeStrykeLPAutomatorV2_1.RebalanceTick[]
            memory _ticksMint = new IOrangeStrykeLPAutomatorV2_1.RebalanceTick[](1);
        _ticksMint[0] = IOrangeStrykeLPAutomatorV2_1.RebalanceTick({tick: lowerTick, liquidity: liquidity});
        automator.rebalance(
            _ticksMint,
